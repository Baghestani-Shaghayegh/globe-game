/**
 * Which countries share a land border, derived from public/data/world.geojson
 * by finding outline vertices two countries have in common.
 *
 * Generated, not hand-written, but checked against the map: neighbour counts
 * for thirty-one countries, a dozen borders that must exist, and ten sea
 * crossings that must not — Spain and Morocco, England and France, Sweden and
 * Denmark — all of which a careless join would invent.
 *
 * It describes THIS dataset, which has no microstates in it: Austria has seven
 * neighbours here rather than eight because Liechtenstein is absent, and Spain
 * has two because Andorra and Gibraltar are too. France borders Brazil and
 * Suriname, which looks wrong and is not: French Guiana.
 *
 * Countries with no land neighbours are left out entirely, so a lookup for an
 * island returns undefined rather than an empty list that has to be explained.
 */
export const BORDERS: Record<string, string[]> = {
  ...
  "Brunei": ["Malaysia"],
  "Bulgaria": ["Greece", "Macedonia", "Republic of Serbia", "Romania", "Turkey"],
  ...
  "Cameroon": ["Central African Republic", "Chad", "Equatorial Guinea", "Gabon", "Niger", "Nigeria", "Republic of the Congo"],
  "Canada": ["USA"],
  "Central African Republic": ["Cameroon", "Chad", "Democratic Republic of the Congo", "Republic of the Congo", "South Sudan", "Sudan"],
  "Chad": ["Cameroon", "Central African Republic", "Libya", "Niger", "Sudan"],
  ...
  "Egypt": ["Israel", "Jordan", "Libya", "Sudan"],
  ...
  "France": ["Belgium", "Brazil", "Germany", "Italy", "Luxembourg", "Spain", "Suriname", "Switzerland"],
  ...
  "Ireland": ["England"],
  "Israel": ["Egypt", "Jordan", "Lebanon", "Syria", "West Bank"],
  "Italy": ["Austria", "France", "Slovenia", "Switzerland"],
  "Ivory Coast": ["Burkina Faso", "Ghana", "Guinea", "Liberia", "Mali"],
  "Jordan": ["Egypt", "Iraq", "Israel", "Saudi Arabia", "Syria", "West Bank"],
  ...
  "Kosovo": ["Albania", "Macedonia", "Montenegro", "Republic of Serbia"],
  ...
  "Macedonia": ["Albania", "Bulgaria", "Greece", "Kosovo", "Republic of Serbia"],
  ...
  "Mozambique": ["Malawi", "South Africa", "Swaziland", "United Republic of Tanzania", "Zambia", "Zimbabwe"],
  ...
  "Niger": ["Algeria", "Benin", "Burkina Faso", "Cameroon", "Chad", "Libya", "Mali", "Nigeria"],
  "Nigeria": ["Benin", "Cameroon", "Niger"],
  ...
  "Portugal": ["Spain"],
  "Qatar": ["Saudi Arabia"],
  "Republic of Serbia": ["Bosnia and Herzegovina", "Bulgaria", "Croatia", "Hungary", "Kosovo", "Macedonia", "Montenegro", "Romania"],
...
/** The countries a country shares a land border with. Islands give []. */
export function neighboursOf(name: string): string[] {
  return BORDERS[name] ?? [];
}
